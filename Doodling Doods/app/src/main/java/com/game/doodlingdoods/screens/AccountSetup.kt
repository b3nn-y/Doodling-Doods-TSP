    ...
    Box(
        ...
        )
        {
            ...
            Image(painter = painterResource(id = R.drawable.login_button),
                contentDescription = "Login Button", modifier = Modifier.clickable(
            ...
            Image(painter = painterResource(id = R.drawable.sign_up_button),
                contentDescription = "Sign Up", modifier = Modifier.clickable(
                    interactionSource = interactionSource,
                    indication = null
                ){
            ...
            Image(painter = painterResource(id = R.drawable.guest_play),
                contentDescription = "Guest Play", modifier = Modifier.clickable(
                    interactionSource = interactionSource,
                    indication = null
                ){
...
@Composable
fun Prev() {
    GuestButton(navController = NavController(LocalContext.current), playerDetailsViewModel = PlayerDetailsViewModel() )
